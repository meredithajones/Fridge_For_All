...
const Home = () => (
  ...
  <p>
    ...
    <p>To get started, click on "Check the Fridge" above. Please note that all non-perishable canned should be pop-tops. If not, please consider donating can openers!  </p>
  </div>
);
